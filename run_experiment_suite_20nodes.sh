...
NODES_VALUES=(20)
REPLICATION_FACTOR_VALUES=(5)
READ_QUORUM_R_VALUES=(1 3 5)
WRITE_QUORUM_W_VALUES=(1 3 5)
FAILURE_MODE_VALUES=(none crash single_partition)
...
EXP_NUM=0
TOTAL_EXPS=$((${#NODES_VALUES[@]} * ${#REPLICATION_FACTOR_VALUES[@]} * ${#READ_QUORUM_R_VALUES[@]} * ${#WRITE_QUORUM_W_VALUES[@]} * ${#FAILURE_MODE_VALUES[@]}))
    ...
    for READ_QUORUM_R in "${READ_QUORUM_R_VALUES[@]}"; do
      for WRITE_QUORUM_W in "${WRITE_QUORUM_W_VALUES[@]}"; do
        for FAILURE_MODE in "${FAILURE_MODE_VALUES[@]}"; do
          ...
          EXP_NAME="nodes${NODES}_rf${REPLICATION_FACTOR}_r${READ_QUORUM_R}_w${WRITE_QUORUM_W}_${FAILURE_MODE}"
          ...
          PORT_RANGE=0
          BASE_PORT=$((40000 + (EXP_NUM - 1) * PORT_RANGE))
